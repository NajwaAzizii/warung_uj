...
<body>
            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="#dataPoliMenu" data-bs-toggle="collapse" aria-expanded="false"
                                aria-controls="dataPoliMenu">
                                <span>
                            ...
                            <!-- Submenu untuk Data Pasien -->
                            <ul class="collapse list-unstyled ms-3" id="dataPoliMenu">
                                <li class="sidebar-subitem">
                    ...
                    <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            <a href="https://adminmart.com/product/modernize-free-bootstrap-admin-dashboard/"
                                target="_blank" class="btn btn-primary">Najwa Azizi</a>
    ...
    <script>
        $(document).ready(function() {
            $('.select2').select2({ //menginisialisasi plugin Select2 pada semua elemen yang memiliki kelas select2
                placeholder: function() {
                    return $(this).data(
                        'placeholder'); // Menampilkan teks placeholder yang diset pada elemen
                },
                allowClear: true, // Memungkinkan pengguna untuk menghapus pilihan
                width: 'resolve' // Mengatur lebar elemen Select2 agar otomatis menyesuaikan lebar elemen
            });
        });
    </script>
</body>
