...
<body class="body-fixed">
    ...
    <div id="viewport">
        <div id="js-scroll-content">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="brands-row">
                                <div class="brands-box">
                                    <img src="/pembeli/assets/images/brands/b1.png" alt="">
                                </div>
                                <div class="brands-box">
                                    <img src="/pembeli/assets/images/brands/b2.png" alt="">
                                </div>
                                <div class="brands-box">
                                    <img src="/pembeli/assets/images/brands/b3.png" alt="">
                                </div>
                                <div class="brands-box">
                                    <img src="/pembeli/assets/images/brands/b4.png" alt="">
                                </div>
                                <div class="brands-box">
                                    <img src="/pembeli/assets/images/brands/b5.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="menu-tab text-center">
                                        <ul class="filters">
                                            ...
                                            <li class="filter" data-filter=".dinner">
                                                <img src="/pembeli/assets/images/menu-4.png" alt="">
                                                Dinner
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="sec-img mt-5">
                                <img src="/pembeli/assets/images/pizza.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="sec-text">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 order-lg-2 order-1">
                            <div class="sec-img">
                                <img src="/pembeli/assets/images/sushi.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        <div style="background-image: url(/pembeli/assets/images/chef/c1.jpg);"
                                ...
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        <div style="background-image: url(/pembeli/assets/images/chef/c2.jpg);"
                                            class="team-img back-img">
                                ...
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        <div style="background-image: url(/pembeli/assets/images/chef/c3.jpg);"
                                            class="team-img back-img">
                                ...
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        <div style="background-image: url(/pembeli/assets/images/chef/c4.jpg);"
                                            class="team-img back-img">
                                ...
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        <div style="background-image: url(/pembeli/assets/images/chef/c5.jpg);"
                                            class="team-img back-img">
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="testimonials-img">
                                    <img src="/pembeli/assets/images/testimonial-img.png" alt="">
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="row">
                                        ...
                                        <div class="testimonials-box">
                                            <div class="testimonial-box-top">
                                                <div class="testimonials-box-img back-img"
                                                    style="background-image: url(/pembeli/assets/images/testimonials/t1.jpg);">
                                                </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="testimonials-box">
                                            <div class="testimonial-box-top">
                                                <div class="testimonials-box-img back-img"
                                                    style="background-image: url(/pembeli/assets/images/testimonials/t2.jpg);">
                                                </div>
                                                <div class="star-rating-wp">
                                                    <div class="star-rating">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="testimonials-box">
                                            <div class="testimonial-box-top">
                                                <div class="testimonials-box-img back-img"
                                                    style="background-image: url(/pembeli/assets/images/testimonials/t3.jpg);">
                                                </div>
                                                <div class="star-rating-wp">
                                                    <div class="star-rating">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="testimonials-box">
                                            <div class="testimonial-box-top">
                                                <div class="testimonials-box-img back-img"
                                                    style="background-image: url(/pembeli/assets/images/testimonials/t4.jpg);">
                                                </div>
                                                <div class="star-rating-wp">
                                                    <div class="star-rating">
            ...
            <section class="faq-sec section-repeat-img"
                style="background-image: url(/pembeli/assets/images/faq-bg.png);">
                <div class="sec-wp">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
            ...
            <div class="bg-pattern bg-light repeat-img"
                style="background-image: url(/pembeli/assets/images/blog-pattern-bg.png);">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="blog-box">
                                        <div class="blog-img back-img"
                                            style="background-image: url(/pembeli/assets/images/blog/blog1.jpg);"></div>
                                        <div class="blog-text">
                                ...
                                <div class="col-lg-4">
                                    <div class="blog-box">
                                        <div class="blog-img back-img"
                                            style="background-image: url(/pembeli/assets/images/blog/blog2.jpg);"></div>
                                        <div class="blog-text">
                                ...
                                <div class="col-lg-4">
                                    <div class="blog-box">
                                        <div class="blog-img back-img"
                                            style="background-image: url(/pembeli/assets/images/blog/blog3.jpg);"></div>
                                        <div class="blog-text">
                            ...
                            <div class="row">
                                <div class="col-lg-8 m-auto">
                                    <div class="newsletter-box text-center back-img white-text"
                                        style="background-image: url(/pembeli/assets/images/news.jpg);">
    ...
    <!-- rellax  -->
    <!-- <script src="/pembeli/assets/js/rellax.min.js"></script> -->
    <!-- <script src="/pembeli/assets/js/rellax-custom.js"></script> -->
    <!-- smooth scroll  -->
