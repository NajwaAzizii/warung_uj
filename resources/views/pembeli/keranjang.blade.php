        ...
        <div class="py-3.5 pl-4 pr-[22px] bg-white rounded-2xl flex gap-1 items-center relative">
          ...
          <div class="flex flex-wrap items-center justify-between w-full gap-1">
            <div class="flex flex-col gap-1">
              ...
              <p class="text-sm text-grey">Rp {{ $keranjang->produk->harga}}</p>
            </div>
      ...
      <div class="p-6 bg-white rounded-3xl" id="__detailsPayment" style="display: none;">
        <ul class="flex flex-col gap-5">
          <li class="flex items-center justify-between">
            ...
            <p class="text-base font-semibold first:font-normal">Rp 890.000</p>
          </li>
          <li class="flex items-center justify-between">
            <p class="text-base font-semibold first:font-normal">PPN 11%</p>
            <p class="text-base font-semibold first:font-normal">Rp 89.000</p>
          </li>
          <li class="flex items-center justify-between">
            <p class="text-base font-semibold first:font-normal">Insurance 23%</p>
            <p class="text-base font-semibold first:font-normal">Rp 120.000</p>
          </li>
          <li class="flex items-center justify-between">
            <p class="text-base font-semibold first:font-normal">Delivery (Promo)</p>
            <p class="text-base font-semibold first:font-normal">Rp 10.000</p>
          </li>
          <li class="flex items-center justify-between">
            <p class="text-base font-bold first:font-normal">Grand Total</p>
            <p class="text-base font-bold first:font-normal text-primary">Rp 3.290.000</p>
          </li>
        </ul>
      </div>
    </section>
      ...
      <div class="p-4 mt-0.5 bg-white rounded-3xl hidden" id="manualPaymentDetail">
        <div class="flex flex-col gap-5">
          ...
          <div class="inline-flex items-center gap-2.5">
            ...
            <p class="text-base font-semibold">Send Payment to</p>
          </div>
          <div class="inline-flex items-center gap-2.5">
    ...
    <div
      ...
      <section class="flex items-center justify-between gap-5">
        <div>
          ...
          <p class="text-lg min-[350px]:text-2xl font-bold text-white">Rp 3.290.000</p>
        </div>
        <button type="button"
          ...
          onclick="window.location.href='{{ url('/pages/success-checkout.html') }}'">
          Confirm
        </button>
      </section>
    </div>
