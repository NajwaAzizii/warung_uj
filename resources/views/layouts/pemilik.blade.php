      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="#dataPasienSubmenu" data-bs-toggle="collapse" aria-expanded="false"
                aria-controls="dataPasienSubmenu">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="#dataPoliSubmenu" data-bs-toggle="collapse" aria-expanded="false"
                aria-controls="dataPoliSubmenu">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="#dataDaftarSubmenu" data-bs-toggle="collapse" aria-expanded="false"
                aria-controls="dataDaftarSubmenu">
                <span>
